...
module ActiveCMIS
  class Object
    ...
    def data
      parameters = {"includeAllowableActions" => true, "renditionFilter" => "*", "includeACL" => false, "filter" => "cmis:creationDate,cm:owner,cmis:changeToken,cm:description,cmis:objectId,cmis:objectTypeId,cmis:lastModifiedBy,cmis:name,cmis:createdBy,cmis:baseTypeId,cmis:creationDate,cmis:lastModificationDate"}
    ...
    class << self
      ...
      def path_from_parameters(repository, parameters)
